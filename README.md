...
Загрузите данные в Python с помощью Pandas
Посчитайте базовые метрики:
Среднее количество сообщений на пользователя
Самую частую оценку бота
Процент пользователей с сессией больше 10 минут
Сделайте 2 простых визуализации (например, гистограмма оценок и scatter plot сообщения vs время)
